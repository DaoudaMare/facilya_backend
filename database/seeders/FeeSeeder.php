...
class FeeSeeder extends Seeder
{
    ...
    protected function fees(): array
    {
        return [
            ...
            [
                'name' => 'Colis plateforme 200 F',
                'transaction_type' => TransactionTypeEnum::PARCEL_SHIPMENT,
                'part' => FeePartEnum::PLATFORM,
                'mode' => FeeModeEnum::FIXED,
                'value' => 200,
                'min_fee' => null,
            ...
            [
                'name' => 'Paiement confiant plateforme 200 F',
                'transaction_type' => TransactionTypeEnum::TRUSTED_PAYMENT,
                'part' => FeePartEnum::PLATFORM,
                'mode' => FeeModeEnum::FIXED,
                'value' => 200,
                'min_fee' => null,
